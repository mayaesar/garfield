...
// this is the code for the play now screen


const addScoreTime = (time, score)=>{
  let timeAdd = Math.round(time); 
  return ("time: " + timeAdd + " Score:" + score);
